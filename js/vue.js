...
import { store, createNotification as createNotification$1, MultiRestError } from '../js/app.js';
...
var Portal = {
  ...
  props: {
    ...
    slotProps: { type: Object, default: () => ({}) },
    tag: { type: [String], default: 'DIV' },
    targetEl: { type: inBrowser$1 ? [String, HTMLElement] : String },
  ...
  return {
    ...
    methods: {
      ...
      copyClipboard: function (event, itemid) {
        ...
        createNotification$1("clipboard", `Copied ${itemid} to clipboard`, false, 3000);
      },
 ...
 */
function determineDifference(after, before, idkey) {
  let created = [];
  let updated = [];
  let updatedOldEntry = [];
  let removed = [];
