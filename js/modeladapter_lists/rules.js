import { store, fetchMethodWithTimeout, createNotification } from '../app.js'; // Pre-bundled, external reference
...
const RulesMixin = {
  ...
  methods: {
    ...
    rulesStatusmessage: function () { return this.item.status ? this.item.status.description : ""; },
