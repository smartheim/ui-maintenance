 ...
 * 
 * Usage:
 * `new OhDataBind("listadapter/items", (status) => { }, (items) => this.items = items);`
 * 
 * @param adapter The adapter name, used to load the correct adapter file. E.g. "listadapter/items" etc.
